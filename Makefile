...
## devstack-osism: Run the small scenario (DEVSTACK_OSISM_SERVICE=neutron|cinder|keystone) against the OSISM testbed, then clean up.
...
## devstack-osism-monitor: Run monitor --otel (DEVSTACK_OSISM_SERVICE=neutron|cinder|keystone) against the OSISM testbed, exporting to VictoriaMetrics.
